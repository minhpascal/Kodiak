...
public class ArcaXDPNormalizer implements IMdNormalizer
{
	...
	public ArcaXDPNormalizer(Map<MdServiceType, IMdLibraryCallback> callbacks, String range, int channel, int index)
	{
		this.bookCache = new BookQuoteCache((IMdBookQuoteListener) callbacks.get(MdServiceType.BOOK_ARCX), MdFeed.ARCA, MdServiceType.BOOK_ARCX, range, channel, index);
